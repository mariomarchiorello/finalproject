...
class ResetPasswordSerializer(serializers.Serializer):
    ...
    def save(self, validated_data):
        ...
        #  send email
        send_mail(
            'Your GOES-App password reset code',
