          ...
          <UploadContainer>
            ...
            <CheckboxFieldsContainer>
              <StandardText>
                ...
                <SmallText>(Select all that apply)</SmallText>
              </StandardText>
              <StandardText>
                Foam{" "}
                <input
                  type={"checkbox"}
                  name={"foam"}
                  onChange={() => setFoamChecked(!foamChecked)}
                  checked={foamChecked}
                />
              </StandardText>
              <StandardText>
                ...
                <input
                  type={"checkbox"}
                  name={"oil"}
                  onChange={() => setOilChecked(!oilChecked)}
                  checked={oilChecked}
                />
              </StandardText>
              <StandardText>
                ...
                <input
                  ...
                  onChange={() =>
                    setBioluminescenceChecked(!bioluminescenceChecked)
                  }
                  checked={bioluminescenceChecked}
                />
              </StandardText>
            </CheckboxFieldsContainer>
            ...
            <CheckboxFieldsContainer>
              <StandardText>
                Weather Events:<SmallText>(Select all that apply)</SmallText>
              </StandardText>
              <StandardText>
                Sun{" "}
                <input
              ...
              <StandardText>
                ...
                <input
                  type={"checkbox"}
                  name={"cloud"}
                  onChange={() => setCloudChecked(!cloudChecked)}
              ...
              <StandardText>
                ...
                <input
                  type={"checkbox"}
                  name={"snow"}
                  onChange={() => setSnowChecked(!snowChecked)}
                  checked={snowChecked}
                />
              </StandardText>
              <StandardText>
                ...
                <input
                  type={"checkbox"}
                  name={"storm"}
                  onChange={() => setStormChecked(!stormChecked)}
                  checked={stormChecked}
                />
              </StandardText>
            </CheckboxFieldsContainer>
            ...
            <BlueButton type="submit" onClick={NewSampleSetHandler}>
              Continue
            </BlueButton>
            <Link to="/summary">
